...
/**
*/
MeshResourceApp::MeshResourceApp()
{
	// empty
}
...
MeshResourceApp::Open()
{
	...
	if (this->window->Open())
	{
		...
		this->sR = ShaderResource();

		// set clear color to gray
		glClearColor(0.1f, 0.1f, 0.1f, 1.0f);

		// create vertex and pixel shader for shader program
		this->vertexShader = sR.SetupShader(vs, GL_VERTEX_SHADER);
		this->pixelShader = sR.SetupShader(ps, GL_FRAGMENT_SHADER);
